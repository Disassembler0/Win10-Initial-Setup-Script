...
# MSFT apps to install or remove when calling InstallThirdPartyBloat or UninstallThirdPartyBloat
$msftApps = @(
	"Microsoft.3DBuilder",
...
Function InstallThirdPartyBloat {
	...
	$thirdPartyApps | ForEach { Get-AppxPackage -AllUsers $_ | ForEach {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"} }
}
